...
- [`subtrace proxy`](/references/subtrace-proxy) - Run a reverse proxy with tracing
- [`subtrace version`](/references/subtrace-version) - Show version information
- [`subtrace worker`](/references/subtrace-worker) - Start a worker node (for self-hosted setups)
